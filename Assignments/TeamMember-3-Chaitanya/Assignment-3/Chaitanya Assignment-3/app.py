...
COS_API_KEY_ID="lpz22egOsu7zJTR8EJwFdEZ_pyWhZt1n2-nE-f3ksFcS"
COS_INSTANCE_CRN= "crn:v1:bluemix:public:cloud-object-storage:global:a/e6d95f8d77d944a490264ff9c50840e8:7f1395c0-8b83-416e-a0ca-dac64f9ae6a7:bucket:cloud-object-storage-l7-cos-standard-ykh"
...
@app.route('/')
def index():
    files = get_bucket_contents('app123')
