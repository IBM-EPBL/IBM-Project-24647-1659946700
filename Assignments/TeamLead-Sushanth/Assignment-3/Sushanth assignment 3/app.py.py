...
COS_API_KEY_ID="6QqNcbv3G3J3hGJQXGBqkTUwCaHVCWjcBW0lhSrM288T"
COS_INSTANCE_CRN= "crn:v1:bluemix:public:cloud-object-storage:global:a/676322cf505545cdbea1ddbefbdaf336:d4a3ee48-3c38-4548-830a-4df65bd8b44b::"
...
@app.route('/')
def index():
    files = get_bucket_contents('app1234')
